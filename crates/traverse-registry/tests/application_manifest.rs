...
#[test]
fn loads_application_manifest_with_generated_component_artifact() {
    let fixture = AppFixture::new("generated-component-artifact");
    fixture.write_hello_world_bundle();

    let bundle = load_application_bundle_manifest(&fixture.app_manifest_path())
        .expect("generated application bundle should validate");

    assert_eq!(bundle.app_id, "hello.world.app");
    ...
    assert!(bundle.components[0].verified_wasm_digest.is_some());
}
