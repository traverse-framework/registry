...
mod tests {
    ...
    fn exercises_runtime_fixture_1() {
        let input = include_bytes!("../tests/cluster-curate.json");
    ...
    fn remains_total_for_truncated_and_corrupted_real_requests() {
        for fixture in [include_bytes!("../tests/cluster-curate.json").as_slice()] {
