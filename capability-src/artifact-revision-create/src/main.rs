...
mod tests {
    ...
    fn exercises_runtime_fixture_1() {
        let input = include_bytes!("../tests/revision-create.json");
    ...
    fn remains_total_for_truncated_and_corrupted_real_requests() {
        for fixture in [include_bytes!("../tests/revision-create.json").as_slice()] {
