...
//! `wasi-capability-runtime` (`#![no_std]`, hand-rolled JSON, only
...
pub extern "C" fn _start() {
    wasi_capability_runtime::run_capability(analyze);
}
...
mod tests {
    ...
    fn analyze_end_to_end_produces_input_dependent_json() {
        let input = wasi_capability_runtime::parse_json(r#"{"document": "INVOICE. Acme Corp owes $500.00"}"#)
